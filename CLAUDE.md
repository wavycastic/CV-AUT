...
This project is indexed by GitNexus as **CV-AUT** (2710 symbols, 5304 relationships, 200 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
