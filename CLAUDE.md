...
This project is indexed by GitNexus as **CV-AUT** (1294 symbols, 2975 relationships, 106 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
