...
This project is indexed by GitNexus as **CV-AUT** (2731 symbols, 5315 relationships, 199 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
